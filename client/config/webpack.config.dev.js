...
module.exports = {
    ...
    entry: [// Include an alternative client for WebpackDevServer. A client's job is to
        ...
        require.resolve('react-dev-utils/webpackHotDevClient'), // We ship a few polyfills by default:
        require.resolve('./polyfills'), // Errors should be considered fatal in development
        require.resolve('react-error-overlay'), // Finally, this is your app's code:
    ...
    resolve: {
        ...
        modules: ['node_modules', paths.appNodeModules].concat(// It is guaranteed to exist because we tweak it in `env.js`
    ...
    module: {
        ...
        rules: [// TODO: Disable require.ensure as it's not a standard language feature.
    ...
    plugins: [// Makes some environment variables available in index.html.
